...
case "$OS" in
    alpine)
        # 执行 Alpine 适配版脚本
        fetch_and_run "https://raw.githubusercontent.com/sistarry/toolbox/main/Alpine/APXary-HTTP.sh"
        ;;
    debian|ubuntu|centos|rocky|almalinux|fedora|*)
        # 执行原版脚本
        fetch_and_run "https://raw.githubusercontent.com/sistarry/toolbox/main/PROXY/Xary-HTTP.sh"
        ;;
esac