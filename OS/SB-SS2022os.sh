...
case "$OS" in
    alpine)
        # 执行 Alpine 适配版脚本
        fetch_and_run "https://raw.githubusercontent.com/sistarry/toolbox/main/Alpine/APSB-SS2022.sh"
        ;;
    debian|ubuntu|centos|rocky|almalinux|fedora|*)
        # 执行原版脚本
        fetch_and_run "https://raw.githubusercontent.com/sistarry/toolbox/main/PROXY/SB-SS2022.sh"
        ;;
esac