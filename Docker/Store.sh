...
declare -A commands=(
    ...
    [4,13]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/monitor.sh)'
    ...
    [13,4]='bash <(curl -fsSL https://raw.githubusercontent.com/sistarry/toolbox/main/Oracle/OCI-Pool.sh)'
    [13,5]='bash <(curl -fsSL https://raw.githubusercontent.com/sistarry/toolbox/main/Oracle/lookbusy.sh)'
